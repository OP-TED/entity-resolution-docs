# Project: Entity Resolution Docs

This is the documentation and specification repository for the Entity Resolution
project. It uses Antora (AsciiDoc) for technical documentation and serves as the
...
This project is indexed by GitNexus as **entity-resolution-docs** (79 symbols, 72 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
