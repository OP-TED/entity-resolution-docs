...
** xref:ERS-ERE-Contract/index.adoc[Entity Resolution Service–Engine Technical Contract (ERS–ERE)]
...
** xref:ERE/ere-reference-impl.adoc[Basic Entity Resolution Engine Reference Implementation]
